                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="input-group mb-3">
                                <select name="status" id="status" class="form-control" onchange="changeColor(this);">
                                    <option value="-1" disabled selected>Durum: Seçiniz</option>
                                    <option value="success" data-color="bg-success">Başarılı </option>
                                    <option value="danger" data-color="bg-danger">Hata</option>
                                    <option value="info" data-color="bg-info">Bilgi</option>
                                    <option value="warning" data-color="bg-warning">Uyarı</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="input-group mb-3">
                                <textarea class="form-control" name="content" placeholder="İçerik" id="content"></textarea>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2 border header ml-0 mr-0 mt-1 mb-0">
                                    <?php switch ($row->status) {
                                        case 'success':
                                            echo '<span class="bg-' . $row->status . '">Başarılı</span>';
                                            break;
                                        case 'danger':
                                            echo '<span class="bg-' . $row->status . '">Hata</span>';
                                            break;
                                        case 'info':
                                            echo '<span class="bg-' . $row->status . '">Bilgi</span>';
                                            break;
                                        case 'warning':
                                            echo '<span class="bg-' . $row->status . '">Uyarı</span>';
                                            break;
                                    }
